...
export const AnimatedTestimonials = ({
  ...
  return (
    (<div
      className="font-poppins !important max-w-sm md:max-w-4xl mx-auto antialiased font-fredoka px-4 md:px-8 lg:px-12 py-20">
      <div className="relative grid grid-cols-1 md:grid-cols-2  gap-20">
        ...
        <div className="h-[200px] flex justify-between flex-col py-4">
          <motion.div
            key={active}
            initial={{
              y: 20,
